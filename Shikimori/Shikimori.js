    ...
    function Component$1(object) {
        ...
        this.body = function (data) {
            data.forEach(function (anime, index) {
                ...
                var itemElement = item.render();
                
                // Добавляем атрибуты для навигации в Lampa 3.1
                itemElement.attr('data-index', index);
                itemElement.attr('tabindex', '-1');
                
                itemElement.on("hover:focus", function () {
                    last = itemElement[0];
                ...
                // Добавляем обработчик клика для совместимости
        ...
        this.start = function () {
            ...
            // Используем новую систему навигации Lampa 3.1
