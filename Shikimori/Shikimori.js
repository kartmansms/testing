(function () {
  ...
  function Component$1(object) {
    ...
    var head = $("<div class='Shikimori-head torrent-filter'>" +
        ...
        "<div class='Shikimori__announce simple-button simple-button--filter selector'>Анонс</div>" +
    ...
    this.create = function () {
      var queryParams = {
        page: object.page || 1,
        sort: object.sort || 'aired_on'
      };

      if (object.status) {
        queryParams.status = object.status;
      }

      API.main(queryParams, this.build.bind(this), this.empty.bind(this));
    };
    ...
    this.headeraction = function () {
      ...
      var announceElement = head.find('.Shikimori__announce');
      announceElement.on('hover:enter', function () {
        Lampa.Activity.push({
          url: '',
          title: 'Shikimori - Анонс',
          component: 'Shikimori',
          page: 1,
          status: 'anons'
        });
